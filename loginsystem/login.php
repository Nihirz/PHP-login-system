...
<body>
    ...
    if ($login) {
        echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
         <strong>Success!</strong> Your are successfully log in.
    ...
    <div class="container my-4">
        ...
        <form action="/LOGINSYSTEM/login.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" placeholder="Enter Your Username" class="form-control" id="username" name="username" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
